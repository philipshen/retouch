(function(root){
'use strict';
const R=root.RetouchResponsive||(typeof require==='function'?require('./responsive.js'):null),keys=['--rt-scale-factor','--rt-scale-move-x','--rt-scale-move-y'];
...
const api={snapshot,write};if(typeof module==='object'&&module.exports)module.exports=api;else root.RetouchGroupScaleClasses=api;
