...
const layoutIcons={flow:'M3 3h5v5H3z M12 3h5v5h-5z M3 12h5v5H3z M12 12h5v5h-5z',row:'M3 5v10 M8 5v10 M13 5v10 M16 10h4 M18 8l2 2-2 2',column:'M5 3h10 M5 8h10 M5 13h10 M10 16v4 M8 18l2 2 2-2',grid:'M3 3h14v14H3z M10 3v14 M3 10h14'};
 ...
 function organize(panel){
  ...
  if(rangeSource&&screenScope){
   const notice=document.createElement('div'),message=document.createElement('span'),preview=document.createElement('button');notice.className='shared-range-notice';notice.setAttribute('role','status');notice.setAttribute('aria-label',sharedInput?'Shared edit range':'Edit range');message.textContent='Preview the edit range to see these changes.';preview.type='button';preview.className='control-button';preview.textContent='Preview edit range';preview.setAttribute('aria-label','Preview edit range');
