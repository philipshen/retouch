...
const layoutIcons={flow:'M3 3h5v5H3z M12 3h5v5h-5z M3 12h5v5H3z M12 12h5v5h-5z',row:'M3 5v10 M8 5v10 M13 5v10 M16 10h4 M18 8l2 2-2 2',column:'M5 3h10 M5 8h10 M5 13h10 M10 16v4 M8 18l2 2 2-2',grid:'M3 3h14v14H3z M10 3v14 M3 10h14'};
 ...
 function organize(panel){
  ...
  const order=['Component','Shared component properties','Position','Selection transform','Combine shapes','Boolean group','Mask','Vector position','Vector size','Geometry',...([...panel.children].some(el=>title(el)==='Vector size')?[]:['Layout']),'Appearance',...((head.dataset.textLayer==='true'||RetouchInspector.isTextLayer(head.dataset.layerTag||''))?['Typography']:[]),'Fill','Fill gradient','Stroke','Stroke gradient','Effects','Image framing','Image','Export'];
