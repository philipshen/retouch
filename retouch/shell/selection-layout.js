(function(root){
 ...
 function singlePosition(el,save,report){
  ...
  function measure(){if(!el?.isConnected||el.ownerDocument.defaultView.getComputedStyle(el).position!=='absolute')throw Error('Choose an absolute layer in the current screen.');return I.positionGeometry(el);}
