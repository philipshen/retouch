(function(root){
 ...
 function mount(section,info,target,save){
  ...
  const reason=!model.editable?model.reason||'A dynamic value controls this rectangle’s corners.':cssReason(target);input.disabled=!!reason;if(reason)input.title=reason;
