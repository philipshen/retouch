(function(){
 ...
 function open(){
  ...
  for(const id of ['layersPanel','panelBody','toolbar','screenPreset']){const target=document.getElementById(id);if(target)observer.observe(target,{subtree:true,childList:true,attributes:true,attributeFilter:['disabled','hidden','title']});}
