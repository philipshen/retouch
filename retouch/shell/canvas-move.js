(function(root){
 ...
 function mount({target,targets=[target],selectionId=target.getAttribute('data-rt'),frame,canvas,mode='move',spacing=null,preserveBox=targets.length>1,opener=root.document.activeElement,onCommit,onEnd,onError,initial=null}){
  ...
  root.document.body.append(surface);if(initial){const e=initial.event,handle=initial.handle;state={id:e.pointerId,handle,x:e.clientX,y:e.clientY,rawX:0,rawY:0,delta:{x:0,y:0}};surface.setPointerCapture(e.pointerId);}
