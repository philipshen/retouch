(function(root){
 ...
 function change(classes,scope,property,value,document=null,relative=false,el=null){
  if(['font-size','line-height','letter-spacing'].includes(property)&&value!==null&&el?.style.getPropertyPriority(property)==='important')throw Error('An important inline rule controls this typography property.');
  ...
  if(addition&&['font-size','line-height','letter-spacing'].includes(property)&&el?.style.getPropertyValue(property))addition='!'+addition.replace(/^!|!$/g,'');
