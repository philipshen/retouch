(function(root){
 ...
 function change(classes,scope,property,value,document=null,relative=false,el=null){
  ...
  if(addition&&R.project(classes,scope).split(/\s+/).some(token=>I.base(token)!==null&&(shorthandMatch(I.base(token))||(sizing||field.ratio)&&field.matches(I.base(token)))&&/^!|!$/.test(token)))addition='!'+addition.replace(/^!/,'');
