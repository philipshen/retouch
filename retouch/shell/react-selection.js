(function(root){
 'use strict';
 const inlineTypography=['font-family','font-size','font-weight','font-style','line-height','letter-spacing','text-decoration-line','text-decoration-style','text-decoration-thickness','text-underline-offset','text-decoration-skip-ink','text-decoration-color','text-indent'];
 ...
 function change(classes,scope,property,value,document=null,relative=false,el=null){
  if(inlineTypography.includes(property)&&value!==null&&el?.style.getPropertyPriority(property)==='important')throw Error('An important inline rule controls this typography property.');
  ...
  if(addition&&inlineTypography.includes(property)&&el?.style.getPropertyValue(property))addition='!'+addition.replace(/^!|!$/g,'');
