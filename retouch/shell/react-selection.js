(function(root){
 ...
 function change(classes,scope,property,value,document=null,relative=false,el=null){
  if(property==='font-size'&&value!==null&&el?.style.getPropertyPriority(property)==='important')throw Error('An important inline rule controls this font size.');
  ...
  if(addition&&property==='font-size'&&el?.style.getPropertyValue(property))addition='!'+addition.replace(/^!|!$/g,'');
