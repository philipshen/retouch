(function(){
 ...
 function render(){
  ...
  I.note(body,'Collections share typed variables across named modes. Definitions are saved to the project. In HTML, React or Liquid projects, select a layer and open Collection bindings to apply variables and choose modes.');
