(function(root){
 ...
 const api={inverse,transform,matricesFor,resizeBounds,selectionKey,capture,mount};if(typeof module==='object'&&module.exports)module.exports=api;else root.RetouchSVGSelection=api;
