(function(){
 ...
 function mountSelection(infos,elements,width,save){
  ...
  if(computed.every(css=>['flex','inline-flex'].includes(css.display))){
   ...
   const alignmentRow=document.createElement('div'),gap=document.createElement('div');alignmentRow.className='layout-alignment-spacing';gap.className='property-pair';gap.append(rows.get('gap'));alignmentRow.append(picker,gap);groups.layout.prepend(alignmentRow);
