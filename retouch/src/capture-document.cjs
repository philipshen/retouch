...
module.exports=function captureDocument({shadowKey}={}){
 ...
 return {html:'<!doctype html>\n'+output.documentElement.outerHTML+'\n',title:document.title,url:location.href,layers:count,shadowRoots:scopeCount,fontFaces,warnings:[...warnings]};
};
