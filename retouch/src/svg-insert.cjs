...
function drawnShape(preset,points){
 ...
 if(preset==='arrow'){const points=require('../shell/svg-draw.js').geometry(preset,{x:x1,y:y1},{x:x2,y:y2}).points;return points?'<polyline data-rt-shape="arrow" points="'+points+'" fill="none" stroke="#6366f1" stroke-width="2"/>':null;}
