...
function create(base){
 ...
 const adapter={...base,
  ...
  capabilities:{...base.capabilities,ops:[...base.capabilities.ops,'moveComponent','moveComponentSelection','reparentComponentSelection',...require('./svelte-component-structure.cjs').types,'setComponentProp','setComponentPropSelection','pasteComponentProps','resetComponentProps','resetComponentPropsSelection']}
 };
