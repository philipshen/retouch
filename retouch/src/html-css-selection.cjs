...
function plan(resolved,op){
 ...
 const selection=op.ids.map(id=>{const r={...resolved,source,hash,elements,element:elements.find(e=>e.id===id)};return {...html.describe(r),...css.describe(r),...require('./html-text-styles.cjs').describe(r),...require('./html-color-styles.cjs').describe(r),...require('./html-effect-styles.cjs').describe(r),...require('./html-variable-bindings.cjs').describe(r)};});
