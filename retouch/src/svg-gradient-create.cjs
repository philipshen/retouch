...
function inspect(resolved,kind){
 ...
 if(selected.attrs.some(a=>['style','class','className'].includes(a.name)&&a.value))reason='This layer has source styles or classes. Edit those paint styles before creating an attribute gradient.';
