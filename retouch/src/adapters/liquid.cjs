...
function describe(resolved) {
  return {...describeElement(resolved),...require('../liquid-text-styles.cjs').describe(resolved),...require('../liquid-color-styles.cjs').describe(resolved),...require('../liquid-effect-styles.cjs').describe(resolved),components:theme.ancestry(resolved),structure:structure.describe(resolved,'liquid')};
}
