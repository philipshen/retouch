...
module.exports = {
  ...
  capabilities: { collectionSelection:true, classAttr: 'class', ops: ['setSVGGeometry', 'renameElement', 'setClassesSelection', 'setClasses', 'setText', 'setChildren', 'setTag', 'setSrc', ...structure.types] },
