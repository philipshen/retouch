...
function describe(resolved){
 ...
 return {svgBooleanGroup:require('../svg-boolean-group.cjs').describe(resolved,'html'),svgBooleanOwner:require('../svg-boolean-group.cjs').owner(resolved,'html'),svgMask:require('../html-svg-mask.cjs').describe(resolved),svgBooleanReplacement:require('../svg-combine-selection.cjs').describe(resolved,'html'),svgGradientCreation:require('../svg-gradient-create.cjs').describe(resolved,'html'),svgGradients:require('../html-svg-gradient.cjs').describe(resolved),svgTransform:require('../svg-transform.cjs').describe(resolved,'html'),svgConversion:require('../svg-convert.cjs').describe(resolved),svgDuplication,svgMovement:require('../svg-move.cjs').describe(resolved),svgDeletion:require('../svg-delete.cjs').describe(resolved),svgInsertion:require('../svg-insert.cjs').describe(resolved),svgGeometry:require('../svg-geometry.cjs').describe(el),structure:{...structure.describe(resolved,'html'),...insertion.describe(resolved),...require('../svg-delete.cjs').describe(resolved),...require('../svg-move.cjs').describe(resolved),...svgDuplication},id:el.id,kind:'host',tag:el.tag,file:resolved.relPath,hash:resolved.hash,className:attr(el,'class')||'',classNameDynamic:false,
...
function planOp(resolved,op){
 const groups=require('../svg-boolean-group.cjs'),blocked=groups.guard(resolved,op,'html');if(blocked)return blocked;if(groups.types.has(op.type))return groups.plan(resolved,op,'html');
