...
module.exports = {
  ...
  applyOp: (resolved,op) => {
    if(op.type==='insertComponent')return require('../transactions.cjs').applyPlan(resolved.appRoot||path.dirname(resolved.file),require('../insert-component.cjs').plan(resolved,op));
