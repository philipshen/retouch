...
module.exports = {
  ...
  applyOp: (resolved,op) => {
    if(op.type==='renameElement')return require('../transactions.cjs').applyPlan(resolved.appRoot||path.dirname(resolved.file),require('../component-layer-name.cjs').plan(resolved,op));
