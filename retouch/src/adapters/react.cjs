...
module.exports = {
  ...
  describe: resolved => {
    ...
    return {...describeElement(resolved),...require('../jsx-text-styles.cjs').describe(resolved),classSelection:resolved.element.kind==='host',svgDeletion,svgMovement,svgDuplication,context:resolved.context||null,
