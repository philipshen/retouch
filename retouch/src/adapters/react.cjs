...
module.exports = {
  ...
  describe: resolved => {
    ...
    if(require('../jsx-group-regroup.cjs').applies(resolved)){Object.assign(base,require('../jsx-group-regroup.cjs').describe(resolved));base.canDelete=require('../jsx-released-delete.cjs').plan(resolved,{type:'deleteElement',fileHash:resolved.hash}).ok;}
