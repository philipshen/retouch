...
module.exports = {
  ...
  capabilities: {
    classAttr: 'className',
    ops: ['insertElement','renameElement', 'insertSVG', 'setSVGGeometry','setSVGTransform', 'convertSVGToPath', 'setClasses', 'setClassesSelection', 'setText', 'setChildren', 'setTag', 'setSrc', ...structure.types],
  },
};
