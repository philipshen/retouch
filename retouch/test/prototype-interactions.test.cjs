...
test('transition grammar constrains action semantics, timing and CSS values',()=>{
 ...
 assert.throws(()=>V.validate([{...item,action:'navigate',transition:{type:'dissolve'}}]));
