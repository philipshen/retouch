...
(async()=>{
 ...
 try{
  ...
  if(process.env.RT_E2E_COMPARE_ORDER){
   ...
   const undoOrder=page.getByRole('button',{name:'Undo screen order',exact:true}),redoOrder=page.getByRole('button',{name:'Redo screen order',exact:true});
