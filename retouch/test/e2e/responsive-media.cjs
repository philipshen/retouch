...
(async()=>{const browser=await browserType.launch(),page=await browser.newPage();try{
 ...
 const previews=await page.evaluate(()=>{
  ...
  const cases=[
   ...
   {choice:{condition:'(aspect-ratio: .75)'},current:{width:390,height:844},expected:{width:633,height:844}},
   {choice:{condition:'(aspect-ratio: .5 / 1)'},current:{width:390,height:844},expected:{width:422,height:844}},
   {choice:{condition:'(aspect-ratio: .375 / .5)'},current:{width:390,height:844},expected:{width:633,height:844}},
