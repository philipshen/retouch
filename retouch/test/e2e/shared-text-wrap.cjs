...
module.exports=async({page,app,kind,read,wait,settled})=>{
 ...
 console.log(kind+': PASS shared Auto/Balance/Pretty/No wrap, scope/reset/undo and important inline longhand refusal');
};
