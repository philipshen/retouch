...
module.exports=async function strokeSettings({page,app,kind,read,wait,settled}){
 ...
 const values=[['line ends','stroke-linecap','round','round','square','square'],['line joins','stroke-linejoin','bevel','bevel','round','round'],['dash pattern','stroke-dasharray','6 3','6px, 3px','12 4','12px, 4px'],['dash offset','stroke-dashoffset','-3','-3px','12%','12%'],['miter limit','stroke-miterlimit','2.5','2.5','6','6'],['stroke scaling','vector-effect','non-scaling-stroke','non-scaling-stroke','none','none']];
